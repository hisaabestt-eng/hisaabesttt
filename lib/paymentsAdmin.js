...
export async function listPayments({ compId, clientId, search, year, yearType, from, to }) {
...
export async function listInvoiceSummaries({ compId, clientId, search, progress, year, yearType, from, to }) {
