...
import { toDateString, applyDateRangeFilter } from "./dates";

export async function listInvoices({ compId, clientId, search, progress, year, yearType, from, to }) {
...
export async function getDetailedInvoices({ compId, clientId, search, year, yearType, lifecycle, from, to }) {
